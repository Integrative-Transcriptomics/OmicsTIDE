...
The user can select a custom [PTCF](DATAFORMATS.md/###-Pairwise-Trend-Comparison-Format-(PTCF)) file generated previously. An example file can be found [here](../static/data/test_data/ptcf).
