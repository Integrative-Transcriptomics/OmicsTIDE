...
function createPills(divID){
	...
	// let intersectingTrends = document.createElement("DIV");
	// intersectingTrends.setAttribute("id", divID + "-intersect-trends");
	// intersectingTrends.style.width = "50%";
	// intersectingTrends.style.height = "100%";
	// intersectingTrends.style.position = "relative";

	// let intersectingTrendsHeader = document.createElement("DIV");
	// intersectingTrendsHeader.setAttribute("id", divID + "-intersect-trends-header");
	// intersectingTrendsHeader.style.height = "10%";
	// intersectingTrendsHeader.style.width = "100%";

	// let intersectingTrendsPlot = document.createElement("DIV");
	// intersectingTrendsPlot.setAttribute("id", divID + "-intersect-trends-plot");
	// intersectingTrendsPlot.style.height = "90%";
	// intersectingTrendsPlot.style.width = "100%";

	// let intersectingTrendsHeaderP = document.createElement("P");
	// intersectingTrendsHeaderP.style.fontSize = "15pt";
	// intersectingTrendsHeaderP.style.textAlign = "center";
	// intersectingTrendsHeaderP.style.color = "#BEBEBE";
	// intersectingTrendsHeaderP.style.verticalAling = "bottom";
	// let intersectingTrendsHeaderText = document.createTextNode("")

	// intersectingTrendsHeaderP.appendChild(intersectingTrendsHeaderText);
	// intersectingTrendsHeader.appendChild(intersectingTrendsHeaderP);


	// let nonIntersectingTrends = document.createElement("DIV");
	// nonIntersectingTrends.setAttribute("id", divID + "-non-intersect-trends");
	// nonIntersectingTrends.style.width = "50%";
	// nonIntersectingTrends.style.height = "100%";
	// nonIntersectingTrends.style.position = "relative";

	// let nonIntersectingTrendsHeader = document.createElement("DIV");
	// nonIntersectingTrendsHeader.setAttribute("id", divID + "-non-intersect-trends-header");
	// nonIntersectingTrendsHeader.style.height = "10%";
	// nonIntersectingTrendsHeader.style.width = "100%";

	// let nonIntersectingTrendsHeaderP = document.createElement("P");
	// nonIntersectingTrendsHeaderP.style.fontSize = "15pt";
	// nonIntersectingTrendsHeaderP.style.textAlign = "center";
	// nonIntersectingTrendsHeaderP.style.color = "#BEBEBE";
	// nonIntersectingTrendsHeaderP.style.verticalAlign = "bottom";
	// let nonIntersectingTrendsHeaderText = document.createTextNode("");

	// nonIntersectingTrendsHeaderP.appendChild(nonIntersectingTrendsHeaderText);
	// nonIntersectingTrendsHeader.appendChild(nonIntersectingTrendsHeaderP);

	// let nonIntersectingTrendsPlot = document.createElement("DIV");
	// nonIntersectingTrendsPlot.setAttribute("id", divID + "-non-intersect-trends-plot");
	// nonIntersectingTrendsPlot.style.height = "90%";
	// nonIntersectingTrendsPlot.style.width = "100%";

	// let intersectingSankey = document.createElement("DIV");
	// intersectingSankey.setAttribute("id", divID + "-intersect-sankey");
	// intersectingSankey.style.width = "50%";
	// intersectingSankey.style.height = "100%";
	// intersectingSankey.style.position = "relative";

	// let intersectingSankeyHeader = document.createElement("DIV");
	// intersectingSankeyHeader.setAttribute("id", divID + "-intersect-sankey-header");
	// intersectingSankeyHeader.style.height = "10%";
	// intersectingSankeyHeader.style.width = "100%";

	// let intersectingSankeyHeaderP = document.createElement("P");
	// intersectingSankeyHeaderP.style.fontSize = "15pt";
	// intersectingSankeyHeaderP.style.textAlign = "center";
	// intersectingSankeyHeaderP.style.color = "#BEBEBE";
	// intersectingSankeyHeaderP.style.verticalAlign = "bottom";
	// let intersectingSankeyHeaderText = document.createTextNode("Trend Comparison");

	// intersectingSankeyHeaderP.appendChild(intersectingSankeyHeaderText);
	// intersectingSankeyHeader.appendChild(intersectingSankeyHeaderP);

	// let intersectingSankeyPlot = document.createElement("DIV");
	// intersectingSankeyPlot.setAttribute("id", divID + "-intersect-sankey-plot");
	// intersectingSankeyPlot.style.height = "90%";
	// intersectingSankeyPlot.style.width = "100%";
	...
	// intersectingTrends.appendChild(intersectingTrendsHeader);
	// intersectingTrends.appendChild(intersectingTrendsPlot);

	// intersectingSankey.appendChild(intersectingSankeyHeader);
	// intersectingSankey.appendChild(intersectingSankeyPlot);	

	// nonIntersectingTrends.appendChild(nonIntersectingTrendsHeader);
	// nonIntersectingTrends.appendChild(nonIntersectingTrendsPlot);

	// intersectingWrapper.appendChild(intersectingTrends);
	// intersectingWrapper.appendChild(intersectingSankey);
	// nonIntersectingWrapper.appendChild(nonIntersectingTrends);
...
/**
  ...
  * @param{String} divId
  */
function populateMatrix(divID){

		for(combination of Object.keys(globalData)){

			let currentDiv = divID + "_" + combination;

			createPills(currentDiv);
			render(JSON.parse(globalData[combination]['intersecting']['data']), currentDiv + "-intersect-data-diagrams-sankey", TabId.matrix);
			
			detailDiagramsPerCluster(
				DiagramId.centroid,
				globalData[combination]['intersecting'],
				currentDiv + "-intersect-data-diagrams-left",
				currentDiv + "-intersect-data-diagrams-right",
				combination + "_matrix_intersecting",
				"intersecting");

				detailDiagramsPerCluster(
					DiagramId.centroid,
					globalData[combination]['nonIntersecting'],
					currentDiv + "-non-intersect-data-diagrams-left",
					currentDiv + "-non-intersect-data-diagrams-right",
					combination + "_matrix_nonIntersecting",
					"nonIntersecting");
		}
}
...
/**
  ...
  * @param{} data
  */
function infoToCells(divId){

	let firstFile = combination.split("_")[0] + "_" + combination.split("_")[1];
	let secondFile = combination.split("_")[2] + "_" + combination.split("_")[3];

	let fontSize = "10pt";

	let firstFileP = document.createElement("P");
	let firstFileText = document.createTextNode(firstFile + " (" + globalData[combination]['info'][firstFile].filename + ") : " + globalData[combination]['info'][firstFile].genes.length + " genes");
	firstFileP.style.fontSize = fontSize;
	firstFileP.appendChild(firstFileText);

	let secondFileP = document.createElement("P");
	let secondFileText = document.createTextNode(secondFile + " (" + globalData[combination]['info'][secondFile].filename + ") : " + globalData[combination]['info'][secondFile].genes.length + " genes");
	secondFileP.style.fontSize = fontSize;
	secondFileP.appendChild(secondFileText);

	let intersectionP = document.createElement("P");
	let intersectionText = document.createTextNode("intersecting genes: " + globalData[combination]['info']['intersecting_genes'].genes.length + " genes");
	intersectionP.style.fontSize = fontSize;
	intersectionP.appendChild(intersectionText);

	let firstFileOnlyP = document.createElement("P");
	let firstFileOnlyText = document.createTextNode(firstFile + " only: " + globalData[combination]['info'][firstFile + "_only"].genes.length + " genes");
	firstFileOnlyP.style.fontSize = fontSize;
	firstFileOnlyP.appendChild(firstFileOnlyText);

	let secondFileOnlyP = document.createElement("P");
	let secondFileOnlyText = document.createTextNode(secondFile + " only: " + globalData[combination]['info'][secondFile + "_only"].genes.length + " genes");
	secondFileOnlyP.style.fontSize = fontSize;
	secondFileOnlyP.appendChild(secondFileOnlyText);

	let intersectingDiv = document.getElementById(divId + "-intersect-trends-plot");
	intersectingDiv.appendChild(firstFileP);
	intersectingDiv.appendChild(secondFileP);
	intersectingDiv.appendChild(intersectionP);

	let nonIntersectingDiv = document.getElementById(divId + "-non-intersect-trends-plot");
	nonIntersectingDiv.appendChild(firstFileP.cloneNode(true));
	nonIntersectingDiv.appendChild(secondFileP.cloneNode(true));
	nonIntersectingDiv.appendChild(firstFileOnlyP);
	nonIntersectingDiv.appendChild(secondFileOnlyP);
}
...
function GenesByDiagramClick(clickedId, data){

	//centroid_exp1_1_file_1_file_2_nonIntersecting

	let dataset = clickedId.split("_")[1];

	let cluster = clickedId.split("_")[2];

	let clickedComparison = clickedId.split("_")[3] + "_" + 
		clickedId.split("_")[4] + "_" + 
		clickedId.split("_")[5] + "_" + 
		clickedId.split("_")[6];
