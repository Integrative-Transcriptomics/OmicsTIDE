...
The tab-based and dynamic implementation of OmicsTIDE enables to break down the analysis of large-scale data sets to a manageable and clear number of genes within three major analysis steps while keeping the option to review, refine or remove (previous) analysis steps. 
